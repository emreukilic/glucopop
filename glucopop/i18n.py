...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "m_settings": "Settings…", "m_setup": "Change sensor / account…", "m_logout": "Sign out (forget account)…", "m_about": "About", "m_quit": "Quit",
        "logout_confirm": "Remove the saved account and credentials from this computer? The setup wizard will open again.",
        ...
        "m_update": "Update to {ver}…", "m_check_update": "Check for updates",
        "n_update_title": "GlucoPop {ver} is available", "n_update_body": "Right-click the tray icon → \"Update to {ver}\" to install.",
        "upd_confirm": "Download and install GlucoPop {ver}? The app restarts automatically.", "upd_downloading": "Downloading update… {p}%",
        "upd_failed": "Update failed: {err}\nYou can download it manually from the Releases page.", "upd_none": "You are on the latest version ({ver}).",
        # errors
        ...
        "people": "People",
        "person_add": "Add a person",
        "person_edit": "Edit",
        "person_delete": "Remove",
        "person_delete_confirm": "Remove {name} and their saved credentials from this computer?",
        "person_limit": "You can follow up to {n} people.",
        "person_alerts": "Alerts for this person",
        "person_alerts_help": "Turn this off to see the value without being warned about their highs and lows.",
        "s_people_help": "Everyone you follow shares the same unit, target range and alert rules. Click a row in the pop-up to make that person the big number.",
        "s_sensor": "Sensor",
        "s_show_others": "Show the others under the value",
        "f_name": "Name",
        "f_name_auto": "from the service",
        "off": "alerts off",
        "forget_all_confirm": "Remove every person and all saved credentials from this computer?",
        "wz_privacy": "Stored only in this computer's credential manager. Nothing is sent anywhere else.",
    },
    "tr": {
        "app": "GlucoPop",
        ...
        "m_settings": "Ayarlar…", "m_setup": "Sensör / hesap değiştir…", "m_logout": "Oturumu kapat (hesabı unut)…", "m_about": "Hakkında", "m_quit": "Çıkış",
        "logout_confirm": "Kayıtlı hesap ve giriş bilgileri bu bilgisayardan silinsin mi? Kurulum sihirbazı yeniden açılacak.",
        ...
        "m_update": "{ver} sürümüne güncelle…", "m_check_update": "Güncelleme denetle",
        "n_update_title": "GlucoPop {ver} çıktı", "n_update_body": "Kurmak için tepsi ikonuna sağ tık → \"{ver} sürümüne güncelle\".",
        "upd_confirm": "GlucoPop {ver} indirilip kurulsun mu? Uygulama otomatik yeniden başlar.", "upd_downloading": "Güncelleme indiriliyor… %{p}",
        ...
        # birden fazla kişi takibi
        "people": "Kişiler",
        "person_add": "Kişi ekle",
        "person_edit": "Düzenle",
        "person_delete": "Kaldır",
        "person_delete_confirm": "{name} ve kayıtlı giriş bilgileri bu bilgisayardan silinsin mi?",
        "person_limit": "En fazla {n} kişiyi takip edebilirsin.",
        "person_alerts": "Bu kişi için uyarılar",
        "person_alerts_help": "Kapatırsan değeri görürsün ama inip çıkışları için uyarı almazsın.",
        "s_people_help": "Takip ettiğin herkes aynı birimi, aynı hedef aralığını ve aynı uyarı kurallarını kullanır. Pencerede bir satıra tıklarsan o kişi büyük gösterilir.",
        "s_sensor": "Sensör",
        "s_show_others": "Diğerlerini değerin altında göster",
        "f_name": "Ad",
        "f_name_auto": "servisten",
        "off": "uyarı kapalı",
        "forget_all_confirm": "Bütün kişiler ve kayıtlı giriş bilgileri bu bilgisayardan silinsin mi?",
        "wz_privacy": "Yalnızca bu bilgisayarın kimlik yöneticisinde saklanır. Başka hiçbir yere gönderilmez.",
    },
}
